...
def bearing_signal_model_local(d, D, contact_angle, n, fault_type, fr, fc, fd, fm, N, variance_factor, fs, k, zita, fn, Lsdof, SNR_dB, q_amp_mod=1):
    ...
    if fault_type == 'inner':
        ...
        if len(fc) > 1:
            ...
            fc_time = interp1d(theta_time, fc, kind='cubic')(t)
            fd_time = interp1d(theta_time, fd, kind='cubic')(t)
            fm_time = interp1d(theta_time, fm, kind='cubic')(t)
